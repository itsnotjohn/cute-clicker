...
void ImGui::BeginGroupPanel( const char *name, bool var, ImVec4 color1, ImVec4 color2, const ImVec2 &size )
{
    ImGui::BeginGroup( );
    ...
    ImGui::Dummy( ImVec2( frameHeight * 0.5f, 0.0f ) );
    ImGui::SameLine( 0.0f, 0.0f );
    var ? ImGui::PushStyleColor( ImGuiCol_Text, color1 ) : ImGui::PushStyleColor( ImGuiCol_Text, color2 );
    ImGui::Text( name );
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, float power)
{
    ...
    // render left part
    RenderFrame(draw_bb.Min, ImVec2(middle.x, draw_bb.Max.y), frame_col, true, g.Style.FrameRounding);

    // render right part
    ImU32 frame_col_after = GetColorU32(g.ActiveId == id ? ImGuiCol_FrameBgActive : g.HoveredId == id ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg, 0.1f);
    RenderFrame(ImVec2(middle.x, draw_bb.Min.y), draw_bb.Max, frame_col_after, true, g.Style.FrameRounding);
